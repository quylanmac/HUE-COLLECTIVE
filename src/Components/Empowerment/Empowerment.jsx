                    ...
                    <div className="Empowerment">
                        ...
                        <div className="topHeader">
                            ...
                            <div className="empowerBox">
                                ...
                                <br></br><br></br>
                                        <b>
                                            Q6. What have been your favorite design classes at UCSD?</b>
                                        <br></br><br></br>
                                ...
                                <br></br><br></br>
                                        <b>
                                            Q7. What valuable skills did you learn that you think every designer should know outside of the classroom?
                                </b><br></br><br></br>
                                ...
                                <br></br><br></br>
                                        <b>
                                            Q8. How would someone get involved with a design project/get experience outside of class?</b>
                                        <br></br><br></br>
                        ...
                        <HashLink smooth to="/issue2" className="end2Button ">
                            <img src={rightDesign} className="responseImg2" />
                        </HashLink>
                    </div>
                </Container>
            </>
