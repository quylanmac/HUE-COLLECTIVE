...
class About extends Component {
    constructor(props, context) {
        ...
        this.handleShowDoodle3 = this.handleShowDoodle3.bind(this);
                                                ...
                                                <div className="TOPCARD mx-auto" style={{ backgroundColor: data.color1 }}>
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col xs={8} md={6} className="mx-auto my-auto">
                                                            ...
                                                            {this.state.showDoodle == 0 ?
                                                                <Card.Img className="img-fluid d-block" src={require(`../../Members/Sketch/${data.image}.png`)} />
                                                                : (this.state.showDoodle == 1 ?
                                                                    <Card.Img className="img-fluid d-block" src={require(`../../Members/Sketch/${data.image}2.png`)} />
                                                                    : (data.bio6 && this.state.showDoodle == 3 ?
                                                                        <Card.Img className="img-fluid d-block" src={require(`../../Members/Sketch/${data.image}4.png`)} />
                                                                        : <Card.Img className="img-fluid d-block" src={require(`../../Members/Sketch/${data.image}3.png`)} />)
                                                                )}
                                                            ...
                                                            <Card.Subtitle className="memberBio">
                                                                <div style={{ marginTop: "5%", marginLeft: "2.5em", marginRight: "2.5em" }}>
                                                                    ...
                                                                    <p>{data.bio}
                                                                        ...
                                                                        {data.bio5}
                                                                        {data.bio6 && <a onMouseOver={this.handleShowDoodle3} onMouseLeave={this.handleCloseDoodle} className="mouseDoodle">{data.bio6}</a>}
                                                                        {data.bio7}
                                                                    </p>
                                                                </div>
                                                            </Card.Subtitle>
